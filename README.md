...
The data is from [Kaggle](https://www.kaggle.com/datasets/jeanmidev/smart-meters-in-london). The data is from smart meters in homes in the London area dataset. The data is from 2011 to 2014. The data is in 30-minute intervals. The data contains power data per half hour as well as several weather features.
